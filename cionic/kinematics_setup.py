...
csv_position_streams = {
    'hips' : 'fquat',
    'l_thigh' : 'fquat', 'r_thigh' : 'fquat',
    'l_shank' : 'fquat', 'r_shank' : 'fquat',
    'l_foot' : 'fquat', 'r_foot' : 'fquat',
    'l_shank_emg' : 'emg', 'r_thigh_emg' : 'emg',
    'l_emg' : 'emg', 'r_emg' : 'emg',
    'l_shank_emg' : 'emg', 'r_shank_emg' : 'emg',
    'l_thigh_emg' : 'emg', 'r_thigh_emg' : 'emg',
    'l_emg' : 'emg',  'r_emg' : 'emg',
    'l_footbed' : 'emg', 'r_footbed' : 'emg',
}
...
def crossings(data, config, elapsed):
    splits = []
    sign = config.get('sign', 0) # -1 negative crossing 0 any crossing 1 positive crossing
