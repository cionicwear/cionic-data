...
reports = {
 ...
 '0X1B2A': {'comments': '?',
            ...
            'word_parser': {}},
 '0X1F1F': {'comments': 'proprietary',
            'no_of_words': 0,
            'type_of_FRS': 'Dynamic calibration',
            'word_parser': {}},
 '0X2D3E': {'comments': '4.3.4',
            'no_of_words': 4,
            'type_of_FRS': 'System orientation',
            'word_parser': {'rotation quat w': (3, 0, 32, 's.30'),
 ...
 '0XA1A2': {'comments': '',
            ...
            'word_parser': {'alpha default 0.3': (4, 0, 32, 'u.20'),
                            ...
                            'reserved': (1, 0, 32, 'u.0')}},
 '0XA1A3': {'comments': '0 - false, 1 - true',
            'no_of_words': 1,
 ...
 '0XC274': {'comments': '?',
            ...
            'word_parser': {}},
 '0XD3E2': {'comments': '4.3.3',
            'no_of_words': 3,
            'type_of_FRS': 'MotionEngine power management',
            'word_parser': {'delta accel in mg': (2, 16, 'u.0'),
 ...
 '0XD402': {'comments': '?',
            ...
            'word_parser': {}},
 '0XD403': {'comments': '0 - gyro period, 1 - use timestamps',
            'no_of_words': 1,
 ...
 '0XED85': {'comments': '',
            ...
            'word_parser': {'accel threshold in m/s^2': (0, 0, 32, 's.24'),
...
for report_id, report in reports.items():
    frs_records.create_rec(report_id, report["no_of_words"], report["word_parser"], report["comments"])
