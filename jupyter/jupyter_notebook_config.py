...
def scrub_output_pre_save(model, **kwargs):
    ...
    # remove outputs and clear execution count
    ...
    for cell in model['content']['cells']:
        ...
        is_param = cell['source'].startswith('#param')
        has_param = param_tag in tags

        if is_param and not has_param:
            tags.append(param_tag)
            cell['metadata']['tags'] = tags
        elif has_param and not is_param:
            tags.remove(param_tag)
            cell['metadata']['tags'] = tags
