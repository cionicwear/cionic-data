# Licenses of our 3rd party dependencies
Below is a grouping by license type (or derived license type) of the 3rd party software that we use in this repository.
...
- [twine](https://github.com/pypa/twine/blob/master/LICENSE)

## BSD 3-Clause
- [ipython](https://github.com/ipython/ipython/blob/master/LICENSE)
...
- [papermill](https://github.com/nteract/papermill/blob/master/LICENSE)
- [scipy](https://github.com/scipy/scipy/blob/master/LICENSE.txt)
- [jupyterlab](https://jupyter.org/governance/projectlicense.html)
